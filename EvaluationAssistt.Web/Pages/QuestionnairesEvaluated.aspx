...
<%--                <tr style="visibility:hidden;">
                ...
                <tr>
                    <td colspan="3">
                        <table id="applyProcess" runat="server" class="label">
                            <tr>
                                <td>&nbsp;</td>
                                <td>Takım Lideri Notu:</td>
                                <td style="vertical-align: bottom">
                                    <a runat="server" id="lblQualityExpertNote">Kalite Uzmanı Notu:</a></td>
                                <td style="vertical-align: bottom;" class="auto-style1">&nbsp;</td>
                            </tr>
                            <tr>
...
<%--                <tr id="tlComment" runat="server">
                    <td></td>
                    <td></td>
                    <td>
                        <asp:TextBox ID="txtTlComment" TextMode="MultiLine" runat="server" Width="183px" Height="42px" Enabled="false"></asp:TextBox>
                    </td>
                </tr>--%>
                <tr>
                    <td colspan="3">
