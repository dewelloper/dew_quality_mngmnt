                ...
                <div style="float: left;">
                    <table cellpadding="3" cellspacing="3">
                        ...
                        <tr>
                            ...
                            <td><span class="label">:</span></td>
                            <td>
                                <dx:ASPxComboBox ID="cmbGroups" ClientInstanceName="cmbGroups" runat="server" ValueType="System.Int32" OnCallback="cmbGroups_Callback" >
...
<%--    <div class="g_12 separator">
    ...
    <div class="g_12">
        <div class="widget_header">
            <h4 class="widget_header_title wwIcon i_16_forms">cagri Listesi</h4>
        </div>
        <div class="widget_contents noPadding">
            <div class="line_grid">
